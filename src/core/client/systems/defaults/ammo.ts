...
function getAmmo(uid: string, hash: number) {
    ...
    alt.Events.emitServer(SYSTEM_EVENTS.PLAYER_EMIT_AMMUNITION_UPDATE, uid, hash, ammo);
}

alt.Events.onServer(SYSTEM_EVENTS.PLAYER_EMIT_AMMUNITION_UPDATE, getAmmo);
